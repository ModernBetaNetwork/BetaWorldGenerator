...
public class WorldGenDungeons173 extends WorldGenerator173 {
    ...
    private ItemStack getRandomItem(Random random) {
        ...
        return i == 0 ? new ItemStack(Material.SADDLE) : (i == 1 ? new ItemStack(Material.IRON_INGOT, random.nextInt(4) + 1) : (i == 2 ? new ItemStack(MODERN_BETA_BREAD) : (i == 3 ? new ItemStack(Material.WHEAT, random.nextInt(4) + 1) : (i == 4 ? new ItemStack(Material.GUNPOWDER, random.nextInt(4) + 1) : (i == 5 ? new ItemStack(Material.STRING, random.nextInt(4) + 1) : (i == 6 ? new ItemStack(Material.BUCKET) : (i == 7 && random.nextInt(100) == 0 ? new ItemStack(Material.GOLDEN_APPLE) : (i == 8 && random.nextInt(2) == 0 ? new ItemStack(Material.REDSTONE, random.nextInt(4) + 1) : (i == 9 && random.nextInt(10) == 0 ? /*new ItemStack(Item.byId[Item.GOLD_RECORD.id + random.nextInt(2)])*/ new ItemStack(random.nextInt(2) == 0 ? Material.MUSIC_DISC_13 : Material.MUSIC_DISC_CAT) : (i == 10 ? new ItemStack(Material.COCOA_BEANS) : null))))))))));
    }
